...
ALLOWED_HOSTS = [
    host.strip()
    for host in os.environ.get('DJANGO_ALLOWED_HOSTS', 'localhost,127.0.0.1,.herokuapp.com,aerokodex.com,www.aerokodex.com,https://aerokodex-ui.com').split(',')
    if host.strip()
]
...
# Optional Cloudflare R2 media storage (S3-compatible)
...
if USE_CLOUDFLARE_R2:
    ...
    AWS_QUERYSTRING_AUTH = os.environ.get('R2_QUERYSTRING_AUTH', 'False').lower() in ('true', '1', 'yes')
